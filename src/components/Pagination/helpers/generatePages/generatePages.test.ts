...
const arrExpectedPage7 = [1, LEFT_SPILL, 4, 5, 6, 7, 8, 9, RIGHT_SPILL, 12];
const arrExpectedPage10 = [1, LEFT_SPILL, 7, 8, 9, 10, 11, 12];
...
describe("generatePages", () => {
  ...
  it("should generate pages when current page near middle", () => {
